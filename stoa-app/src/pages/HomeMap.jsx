...
export default function HomeMap() {
  ...
  var fetchNearbyShops = useCallback(function(lat, lng) {
    ...
    fetch("https://places.googleapis.com/v1/places:searchNearby", {
      ...
      body: JSON.stringify({ includedTypes: ["coffee_shop", "cafe", "espresso_bar", "coffee_roasteries", "coworking_space" ], maxResultCount: 20, locationRestriction: { circle: { center: { latitude: lat, longitude: lng }, radius: 5000.0 } } }),
